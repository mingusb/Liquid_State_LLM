...
LATEST_ITER="\$(ls -td "\$RUN_DIR"/iterations/iteration\_\* 2\>/dev/null \| head -n 1)"
...
Rubric_N -\> Rubric\_(N-1) -\> ... -\> Rubric_1 -\> Rubric_0.
...
Recovery must occur in later iteration(s), not the same counted step as the first destabilization (min_recovery_iteration_gap=1).
...
- collateral/Rubric\_\<k\>/manifest_iteration_XXX.md

- collateral/Rubric\_\<k\>/access_log_iteration_XXX.md
